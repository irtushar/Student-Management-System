...
public class StudentOperation
{
	...
	public void registration(ArrayList <Student> students)
	{
		...
		System.out.printf("Please Enter Mobile Number: ");
		String mobile = scanner.next();
		
		System.out.printf("Please Enter A Valid Id: ");
		String id = scanner.next();
		
		System.out.printf("Please Enter Student Year: ");
		...
		System.out.printf("One student is inserted. Now total student are:"+ students.size()+"\n");
		System.out.print("\n");
    }
